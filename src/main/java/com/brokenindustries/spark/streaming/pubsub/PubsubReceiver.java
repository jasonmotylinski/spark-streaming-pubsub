...
/**
 * Copied from: https://github.com/GoogleCloudPlatform/spark-examples/blob/master/gaming/java/src/main/java/com/google/cloud/sparkdemo/CloudPubsubReceiver.java
 */
public class PubsubReceiver<T> extends Receiver<T> {
    ...
    public PubsubReceiver(String projectName, String topicName, String subscriptionName, Duration checkpointInterval,
